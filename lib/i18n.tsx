...
const en: Translations = {
  ...
  hero_title: "Yunnan Plateau Supply Chain", hero_tagline: "Yunnan Plateau · Fresh Produce · Global Supply", hero_subtitle: "Direct Sourcing · Cold Chain Logistics · Full Traceability\nFrom Yunnan's highlands to your markets — freshness guaranteed at every step", hero_cta_contact: "Partner With Us", hero_cta_products: "Explore Products", hero_cta_contact_en: "", hero_cta_products_en: "",
  ...
  adv_title: "Why Choose Us", adv_title_en: "", adv_subtitle: "Three pillars that make our supply chain the preferred choice for distributors and retailers across China and beyond",
  flow_title: "How We Work", flow_title_en: "", flow_subtitle: "Four simple steps to start your supply partnership",
  ...
  products_title: "Featured Products", products_title_en: "", products_subtitle: "Premium produce from Yunnan's six legendary growing regions, sourced directly from partner farms", products_view_all: "View All Products", products_seasonal: "",
  trust_title: "The Yunnan Advantage", trust_item1_title: "Farm-Direct", trust_item1_desc: "Our partner network spans 50+ farms across all 6 major Yunnan growing regions. No brokers, no markups — just transparent pricing from field to freight.", trust_item2_title: "Certified Quality", trust_item2_desc: "Every batch is traceable to its source. All partner farms hold China Green Food certification. Third-party pesticide residue testing is standard and public.", trust_item3_title: "Dedicated Service", trust_item3_desc: "You get a personal account manager — one point of contact from product selection through delivery. We respond within hours, not days.",
  card_trace: "Traceability", card_inquire: "Inquire", card_season: "Season",
  contact_title: "Get in Touch", contact_title_en: "", contact_subtitle: "Let's bring the finest produce from Yunnan's highlands to your customers",
  ...
  faq_q1: "How do I get started?", faq_a1: "Fill out the inquiry form or call us directly. Tell us what you need and we'll respond with pricing and samples within 24 hours.",
  faq_q2: "What's the minimum order quantity?", faq_a2: "MOQs vary by product, typically starting at 100kg. We welcome trial orders — let's discuss what works for you.",
  faq_q3: "How does shipping work?", faq_a3: "We handle end-to-end cold chain logistics. Produce ships from Yunnan and arrives at major Chinese cities within 48 hours. Prefer your own carrier? No problem.",
  faq_q4: "How do you guarantee quality?", faq_a4: "Every batch is fully traceable with third-party lab reports. All partner farms are Green Food certified. We test for pesticide residues as standard practice.",
  faq_q5: "Can you issue formal invoices?", faq_a5: "Yes. We issue standard and special VAT invoices (增值税专用发票) with corporate bank transfer support.",
  about_title: "About Us", about_title_en: "", about_subtitle: "From Yunnan's highlands to tables worldwide",
  ...
  videos_title: "Origin Gallery", videos_title_en: "", videos_subtitle: "See the source. Meet the farmers. Experience the harvest.", videos_empty: "Videos coming soon — our partner farms are preparing fresh content", videos_submitted_by: "Submitted by",
  ...
  footer_brand: "Yunnan Plateau Supply Chain", footer_desc: "Premium Yunnan produce. Farm-direct sourcing. Cold chain delivery.", footer_desc_en: "Every shipment arrives as fresh as the day it was picked.", footer_nav: "Navigation", footer_nav_en: "", footer_contact: "Contact Us", footer_contact_en: "",
