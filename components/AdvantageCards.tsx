...
export default function AdvantageCards() {
  ...
  const advantages = [
    { icon: "🌱", title: settings.advantage_1_title || "源头种植", en: "Direct Sourcing", description: settings.advantage_1_desc || "" },
    { icon: "🚛", title: settings.advantage_2_title || "冷链直发", en: "Cold Chain", description: settings.advantage_2_desc || "" },
    { icon: "✅", title: settings.advantage_3_title || "品控溯源", en: "Traceability", description: settings.advantage_3_desc || "" },
  ];
