...
export default function AdvantageCards() {
  ...
  const advantages = [
    { icon: "🌱", title: settings.advantage_1_title || t.trust_item1_title, en: "Direct Sourcing", description: settings.advantage_1_desc || "" },
    { icon: "🚛", title: settings.advantage_2_title || t.trust_item2_title, en: "Cold Chain", description: settings.advantage_2_desc || "" },
    { icon: "✅", title: settings.advantage_3_title || t.trust_item3_title, en: "Traceability", description: settings.advantage_3_desc || "" },
  ];
