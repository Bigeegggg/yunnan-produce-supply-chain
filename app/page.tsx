    ...
    <>
      ...
      <section className="py-16 bg-white border-b border-sand/30">
        <div className="max-w-5xl mx-auto px-4 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            { value: "6+", label: t.stat_regions, en: "", icon: "🏔️" },
            { value: "50+", label: t.stat_farms, en: "", icon: "🤝" },
            { value: "48h", label: t.stat_delivery, en: "", icon: "🚛" },
            { value: "9+", label: t.stat_categories, en: "", icon: "📦" },
          ].map(s => (
            <div key={s.label}>
