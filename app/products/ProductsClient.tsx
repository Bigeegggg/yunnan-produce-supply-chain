    ...
    <>
      <section className="pt-28 pb-12 bg-warm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl sm:text-5xl font-bold text-text-primary tracking-wide mb-4">产品展示</h1>
          <p className="text-text-primary/50 max-w-xl mx-auto">云南高原四季物产，从田间到餐桌的供应链全程把控</p>
        </div>
      </section>
